...
import com.persiancalendar.deskclock.alarms.AlarmStateManager;
import com.persiancalendar.deskclock.controller.Controller;
import com.persiancalendar.deskclock.data.DataModel;
import com.persiancalendar.deskclock.data.Timer;
import com.persiancalendar.deskclock.data.Weekdays;
import com.persiancalendar.deskclock.events.Events;
import com.persiancalendar.deskclock.provider.Alarm;
import com.persiancalendar.deskclock.provider.AlarmInstance;
import com.persiancalendar.deskclock.timer.TimerFragment;
import com.persiancalendar.deskclock.timer.TimerService;
import com.persiancalendar.deskclock.uidata.UiDataModel;
import com.persiancalendar.deskclock.provider.ClockContract;
...
import static com.persiancalendar.deskclock.AlarmSelectionActivity.ACTION_DISMISS;
import static com.persiancalendar.deskclock.AlarmSelectionActivity.EXTRA_ACTION;
import static com.persiancalendar.deskclock.AlarmSelectionActivity.EXTRA_ALARMS;
...
public class HandleApiCalls extends Activity {
    ...
    public static void dismissAlarmInstance(AlarmInstance instance, Activity activity) {
        ...
        if (instance.mAlarmState == ClockContract.InstancesColumns.FIRED_STATE || instance.mAlarmState == ClockContract.InstancesColumns.SNOOZE_STATE) {
