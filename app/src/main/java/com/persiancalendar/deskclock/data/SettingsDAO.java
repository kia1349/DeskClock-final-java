...
package com.persiancalendar.deskclock.data;
...
import com.persiancalendar.deskclock.settings.ScreensaverSettingsActivity;
import com.persiancalendar.deskclock.settings.SettingsActivity;
...
final class SettingsDAO {
     ...
     */
    static DataModel.CitySort getCitySort(SharedPreferences prefs) {
    ...
    static void toggleCitySort(SharedPreferences prefs) {
        final DataModel.CitySort oldSort = getCitySort(prefs);
     ...
     */
    static DataModel.ClockStyle getClockStyle(Context context, SharedPreferences prefs) {
    ...
    static void setDefaultDisplayClockSeconds(Context context, SharedPreferences prefs) {
        if (!prefs.contains(SettingsActivity.KEY_CLOCK_DISPLAY_SECONDS)) {
            ...
            final boolean isAnalog = getClockStyle(context, prefs) == DataModel.ClockStyle.ANALOG;
     ...
     */
    static DataModel.ClockStyle getScreensaverClockStyle(Context context, SharedPreferences prefs) {
    ...
    static Weekdays.Order getWeekdayOrder(SharedPreferences prefs) {
        ...
        switch (firstCalendarDay) {
            case SATURDAY: return Weekdays.Order.SAT_TO_FRI;
            case SUNDAY: return Weekdays.Order.SUN_TO_SAT;
            case MONDAY: return Weekdays.Order.MON_TO_SUN;
            default:
     ...
     */
    static DataModel.AlarmVolumeButtonBehavior getAlarmVolumeButtonBehavior(SharedPreferences prefs) {
        ...
        switch (value) {
            case SettingsActivity.DEFAULT_VOLUME_BEHAVIOR: return DataModel.AlarmVolumeButtonBehavior.NOTHING;
            case SettingsActivity.VOLUME_BEHAVIOR_SNOOZE: return DataModel.AlarmVolumeButtonBehavior.SNOOZE;
            case SettingsActivity.VOLUME_BEHAVIOR_DISMISS: return DataModel.AlarmVolumeButtonBehavior.DISMISS;
            default:
    ...
    private static DataModel.ClockStyle getClockStyle(Context context, SharedPreferences prefs, String key) {
