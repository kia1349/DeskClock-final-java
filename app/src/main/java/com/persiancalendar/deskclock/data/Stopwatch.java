...
import static com.persiancalendar.deskclock.data.Stopwatch.State.PAUSED;
import static com.persiancalendar.deskclock.data.Stopwatch.State.RESET;
import static com.persiancalendar.deskclock.data.Stopwatch.State.RUNNING;
...
public final class Stopwatch {
    ...
    Stopwatch start() {
        ...
        return new Stopwatch(RUNNING, Utils.now(), Utils.wallClock(), getTotalTime());
    }
