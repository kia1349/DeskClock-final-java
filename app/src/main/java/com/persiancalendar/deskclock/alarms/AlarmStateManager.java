 ...
 */
package com.persiancalendar.deskclock.alarms;
...
import com.persiancalendar.deskclock.AlarmAlertWakeLock;
import com.persiancalendar.deskclock.AlarmClockFragment;
import com.persiancalendar.deskclock.AlarmUtils;
import com.persiancalendar.deskclock.AsyncHandler;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "com.persiancalendar.deskclock.ALARM_CHANGED";
